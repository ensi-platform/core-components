...
export const createUIEvent = <T extends Element, E extends Event>(event: E): UIEvent<T, E> => ({
...
export const createSyntheticMouseEvent = <T extends Element>(event: MouseEvent): ReactMouseEvent<T, MouseEvent> => ({
