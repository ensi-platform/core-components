...
import type { Actions, IOptionsFetcherResponse, IUseLazyLoadingProps } from '../types';
...
export function useLazyLoading({
    ...
    const onQueryStringChange = useCallback<Exclude<TInputProps['onChange'], undefined>>((_, payload) => {
