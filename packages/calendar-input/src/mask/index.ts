...
import type { DateTemplate, View } from '../types';
...
function createMaskExpression({ segments: templateSegments, separators }: DateTemplate): MaskitoMask {
...
export function createMaskOptions(
    ...
    return {
        ...
        preprocessors: [
            ...
            ...(autoCorrection ? [createValidationPreprocessor(template, stringTemplate, min, max, onCorrection)] : []),
        ],
